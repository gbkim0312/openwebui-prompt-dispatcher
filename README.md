...
즉시 전송과 예약 작업 화면에서 **웹 검색 사용**을 켤 수 있습니다. 기간은 오늘·최근 24시간, 최근 7일, 최근 1개월, 최근 1년 중 선택합니다. 직접 Tavily 검색은 뉴스(`topic: news`)만 대상으로 하며, 결과가 부족할 때 이전 기사를 섞지 않도록 모델에도 지시합니다.
